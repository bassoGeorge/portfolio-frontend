...
describe('[contact:store] actions', () => {
	it("'updateField' should set error=false and the value=given value for name|body field on non-empty value", () => {
	...
	it("'updateField' should set error=true and the value='' for name|body field on empty value", () => {
		const commit = sinon.spy()
	...
	it("'updateField' should set error=false and value is given value for email field on valid email", () => {
		const commit = sinon.spy()
	...
	it("'updateField' should set error=true and value is given value for email field on invalid email", () => {
		const commit = sinon.spy()
	...
	it("'updateField' should never set error=true for subject as it's optional", () => {
		const commit = sinon.spy()
